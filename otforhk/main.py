...
text2 = [
    ("0 cycle all knights stages", "Knight 1: Superbreak Knight 2: DoT Knight 3: Castorice"),
    ...
    ("I DID IT MIYABROS", "After not pulling for anyone except for burnice, I got M6S1 after 700ish pulls. Could have saved some money if I waited for more free polychromes from upcoming events, but my impatient ahh spent around $200 to get her to m6 and it was so worth it. Hope all miyabros won their 50/50s and got her"),
    ("I GOT HER", "I really like her design and character demo so I immediately went on zzz when the banner reset and I brought her home early within 70 pulls. Although i still have around 11000 polychromes, im probably gonna skip her w engine to save for queen miyabi")
]
@bot.event
async def on_ready():
    print(f"/networth")
